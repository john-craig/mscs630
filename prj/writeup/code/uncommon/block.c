...
#include "maru/maru.h"
#include "maru/maru_bsd_ioctl.h"
#include "kue/kue-api.h"
...
/* sets blocksize on aspect device */
 int maru_set_blocksize(int fd, int blocksize)
{
 ...
 int maru_handle_chunk(char *data, m_u64 offset, m_u32 length, maruReqOp operation, maruAspect *aspect)
{
    maruReq req;
    m_u32 num_blocks;
