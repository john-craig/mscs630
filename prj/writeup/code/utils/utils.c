...
/***************************************************************************/
/* These functions perform reallocation and free of pointers while reading */
/* psuedo-random data into the pointers beforehand. This means the actual  */
/* contents of the pointers are erased before they are returned to the     */
/* memory manager. Probably has performance implications -- I don't care.  */
/***************************************************************************/

// void *mrealloc(void *ptr, size_t sz) {
//     //Fill pointer with psuedorandom data
//     int fd = open(_PATH_URANDOM, O_RDONLY);
//     read(fd,ptr,sz);
//     close(fd);
...
// void mfree(void *ptr) {
//     //Fille pointer with psuedorandom data
//     int fd = open(_PATH_URANDOM, O_RDONLY);
//     read(fd,ptr,sz);
//     close(fd);
