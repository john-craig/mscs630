 ...
 unsigned long strHash (unsigned long h, char *s)
{
 ...
 struct strList * strListAdd (struct strList *l, char *s)
{
	if (l)
	{
 ...
 void strListFree (struct strList *l)
{
	l = l->head;
	while (l)
	{
...
#if 0
 struct strList *strBinListAdd (struct strBinList *l, char *s)
{
	if (l)
	{
		l->next = (struct strList *) Smalloc (sizeof *l);
 ...
 void strBinListFree (struct strBinList *l)
{
	l = l->head;
	while (l)
	{
 ...
 */
 ...
 struct strStack *strStackAdd (struct strStack *l, char *s)
{
	int len;
	len = strlen (s);
	if (!l)
...
ret:
 ...
 struct strStack *strnStackAdd (struct strStack *l, char *s, int len)
{
	if (!l)
	{
		l = Smalloc (sizeof *l);
 ...
 void strStackFree (struct strStack *l)
{
	free (l->data);
	free (l);
}

 void strStackTrim (struct strStack *l)
{
