...
public class AESCipher {
    ...
    /* XORs the input hex matrices and returns the result */
    ...
    /* Substitutes the nibbles of a hex matrix and returns the result */
    ...
    /* Shifts the rows of a hex matrix */
    ...
    /* Performs GF multiplication to mix the columns of the hex matrix */
    ...
    /* Generates the matrix of AES round keys from the key matrix;
     accepts input and returns output in the form of strings */
    ...
    /* Returns a two-dimensional array of integers containing the round keys
    generated by a two-dimensional array of integers for the key matrix */
    ...
    /* Converts a string of characters 0-9, A-F into an array of integers */
    ...
    /* Converts an array of integers into the equivalent character literals*/
    ...
    /* Returns the AES box conversion for a given byte */
    ...
    /* Returns the round constant for a given round */
    ...
    /* Utility method to print a two-dimensional array of hex */
